...
int main() {
 ...
 Data curvatureData_50 = read_csv(path + "navier_50/curvature.csv");
  ...
  double value_c = 0.012;
  double value_c_tolerance = 0.001;
  
  bool success_curvature_25 = verify(curvatureData_25, 1.8, time_tolerance, value_c, value_c_tolerance);
  bool success_curvature_50 = verify(curvatureData_50, 1.8, time_tolerance, value_c/2, value_c_tolerance);
  bool success_curvature_100 = verify(curvatureData_100, 1.8, time_tolerance, value_c/4, value_c_tolerance);
  bool success_curvature_200 = verify(curvatureData_200, 1.8, time_tolerance, value_c/8, value_c_tolerance);
