...
plot "contactAngle.csv" using 1:2 title "LevelSet" with points pointsize 0.5,\
     "contactAngle.csv" using 1:3 title "Reference" with points pointsize 0.5
...
plot "curvature.csv" using 1:2 title "LevelSet" with points pointsize 0.5,\
     "curvature.csv" using 1:3 title "Reference" with points pointsize 0.5 
     
set output "result_gradient_norm.pdf"
set ylabel "|grad \phi|"

plot "gradientNormAtContactPoint.csv" using 1:2 title "LevelSet" with points
