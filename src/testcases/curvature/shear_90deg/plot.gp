...
set output "results_curvature_shear.pdf"
set ylabel "Curvature"

plot "shear_25/curvature.csv" using 1:2 every 2 title "dx = 0.004" with points pointsize 0.5,\
     "shear_50/curvature.csv" using 1:2 every 4 title "dx = 0.002" with points pointsize 0.5,\
     "shear_100/curvature.csv" using 1:2 every 8 title "dx = 0.001" with points pointsize 0.5,\
     "shear_200/curvature.csv" using 1:2 every 16 title "dx = 0.0005" with points pointsize 0.5,\
     "shear_25/curvature.csv" using 1:3 every 1 title "Reference" with line black

set ylabel "Error in Curvature"
set output "error_curvature_shear.pdf"

plot "shear_25/curvature.csv" using 1:($2-$3) every 2 title "dx = 0.004" with points pointsize 0.5,\
     "shear_50/curvature.csv" using 1:($2-$3) every 4 title "dx = 0.002" with points pointsize 0.5,\
     "shear_100/curvature.csv" using 1:($2-$3) every 8 title "dx = 0.001" with points pointsize 0.5,\
     "shear_200/curvature.csv" using 1:($2-$3) every 16 title "dx = 0.0005" with points pointsize 0.5,\
