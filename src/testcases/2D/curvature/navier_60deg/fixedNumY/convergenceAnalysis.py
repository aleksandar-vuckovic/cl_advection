...
plt.subplot(4, 1, 1)
plt.plot(CFL, maxDifferenceAngle, linestyle="None", marker ="x")
plt.ylabel("max difference in angle")

plt.subplot(4, 1, 2)
plt.plot(CFL, maxDifferencePosition, linestyle="None", marker="x")
plt.ylabel("max differnce in position")

plt.subplot(4, 1, 3)
plt.plot(CFL, maxDifferenceCurvatureDivergence, linestyle="None", marker="x")
plt.ylabel("diff in curvature (divergence)")

plt.subplot(4, 1, 4)
plt.plot(CFL, maxDifferenceCurvatureHeight, linestyle="None", marker="x")
