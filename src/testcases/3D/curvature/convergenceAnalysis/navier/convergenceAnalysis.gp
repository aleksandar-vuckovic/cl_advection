...
set ylabel "Error CurvatureDerivative"
plot testcase."_25/curvatureDerivative.csv" using 1:($2-$3) title "dx = 0.004" with points pointsize 0.5,\
     testcase."_50/curvatureDerivative.csv" using 1:($2-$3) title "dx = 0.002" with points pointsize 0.5,\
     testcase."_100/curvatureDerivative.csv" using 1:($2-$3) title "dx = 0.001" with points pointsize 0.5,\
     testcase."_200/curvatureDerivative.csv" using 1:($2-$3) title "dx = 0.0005" with points pointsize 0.5,\