...
plot "curvature.csv" using 1:2 every 10 title "LevelSet" with points pointsize 0.5,\
     "curvature.csv" using 1:3 every 10 title "Reference" with points pointsize 0.5 
