...
plot testcase."_25/contactAngle.csv" using 1:2 every 2 title "dx = 0.004" with points pointsize 0.5,\
     ...
     testcase."_25/contactAngle.csv" using 1:3 every 1 title "Reference" with points pointsize 0.5 black
...
plot testcase."_25/position.csv" using 1:2 every 2 title "dx = 0.004" with points pointsize 0.5,\
     ...
     testcase."_25/position.csv" using 1:3 every 1 title "Reference" with points pointsize 0.5 black
